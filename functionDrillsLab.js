...
console.log(exclaimTwo('asdasdasd'));
...
let nameGreeting = nameCheck('ian');
...
console.log(bestMovie('tropic thunder'));
...
console.log(emailCheck('ian@gmail.com       '));
...
//CODE HERE
const buysChoc2 = (gold) => {
  gold -= gold % 3;
  return (gold /= 3);
};
// console.log(buysChoc2(4));
//we already solved it first time around
////////////////// PROBLEM 21 ////////////////////
